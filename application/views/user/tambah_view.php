                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lahir" required="required" placeholder="Enter Tempat Lahir">
                                </div>
                                <div class="form-group">
                                    <label>Tanggal Lahir</label>
                                    <input type="date" class="form-control" name="tgl_lahir" required="required" placeholder="Enter Tanggal Lahir">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>Telepon</label>
                                    <input id="uintTextBox" class="form-control" name="telepon" required="required" placeholder="Enter Nomor Telepon">
                                </div>
                                <div class="form-group">
                                    <label>E-mail</label>
